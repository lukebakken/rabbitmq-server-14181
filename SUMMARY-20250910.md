...
1. **Phase 1 (1.5 hours)**: Run `repro.py` to create fragmentation
...
1. **Simultaneous Start**: Both `repro.py` and PerfTest started together
...
- 1.5 hours of `repro.py` followed by PerfTest
